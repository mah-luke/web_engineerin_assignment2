...
describe('Cart', () => {
  ...
  test_(309, 'Remove two items via button', async (steps, chance) => {
  ...
  test_(310, 'Cache Met objects', async (steps, chance) => {
  ...
  test_(311, 'Show number of items in cart', async (steps, chance) => {
